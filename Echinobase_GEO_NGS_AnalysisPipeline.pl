...
############### Please Contact Praneet Chaturvedi on Github for bugs or issues ##############
...
############## Information ###############
print "\nEchinobase GEO NGS Analysis Pipeline \-\-version 1.0\n";
print "\nPlease cite Echinobase and NGS pipline when using for your research\n";
