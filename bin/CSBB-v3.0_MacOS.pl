...
if(($user_input eq "Process-RNASeq_SingleEnd")||($user_input eq "--Process-RNASeq_SingleEnd")||($user_input eq "RNASeq-Single"))
{
 ...
 my $species=$ARGV[2]; ########### Works for Echinobase, human, mouse, frog and zebrafish
...
if(($user_input eq "Process-RNASeq_PairedEnd")||($user_input eq "--Process-RNASeq_PairedEnd")||($user_input eq "RNASeq-Paired"))
{
 ...
 my $species=$ARGV[3]; ########### Works for Echinobase, human, mouse, frog and zebrafish
...
sub help
{
 ...
 print "\nProcess\-RNASeq\_SingleEnd     \-\-\-\> for processing Single End RNASeq data using RSEM for echinobase, human, mouse, frog and zebrafish\n";
 print "\nProcess\-RNASeq\_PairedEnd     \-\-\-\> for processing Paired End RNASeq data using RSEM for echinobase, human, mouse, frog and zebrafish\n";
 ...
 print "\nProcess-ChIP-ATAC_SingleEnd    \-\-\-\> for processing Single End ChIP and ATAC Seq data for echinobase, human, mouse and frog\n";
 print "\nProcess-ChIP-ATAC_PairedEnd    \-\-\-\> for processing Paired End ChIP and ATAC Seq data for echinobase, human, mouse and frog\n";
}
##################### MODULE END #####################
...
sub ProcessRNASeqSingle
{
 ...
 if($species eq "")
 {
  print "\nPlease provide the species \.\. Options : echinobase-pmin, echinobase-spur, human or mouse or xenopus-laevis or xenopus-trop or zebrafish\n";
 ...
 {
  my $rsem_index=$cwd."\/"."Modules"."\/"."RSEM_ECHINOBASE/Pmin";
  my $path_to_bamtobigwig=$cwd."\/"."Modules"."\/"."Bedgraph_Bigwig_MAC"."\/"."./bedGraphToBigWig";
  my $path_to_chromsize="6.08e8";
  my $genomesize="6.08e8";
  my $start_time=time();
 ...
 {
  my $rsem_index=$cwd."\/"."Modules"."\/"."RSEM_ECHINOBASE/Spur";
  my $path_to_bamtobigwig=$cwd."\/"."Modules"."\/"."Bedgraph_Bigwig_MAC"."\/"."./bedGraphToBigWig";
  my $path_to_chromsize="9.22e8";
  my $genomesize="9.22e8";
  my $start_time=time();
...
sub GenerateTPMCounts
{
 ...
 if($Species eq "")
 {
  print "\nPlease provide Species \.\. Options \: echinobase-pmin, echinobase-spur, human or mouse or xenopus-laevis or xenopus-trop or zebrafish \n";
  $Species=<stdin>;chomp $Species;
 }
 if($output_dir eq "")
 {
 ...
 if($Species eq "echinobase-pmin")
 {
  print "Read all parameters \.\. Starting execution\n";
  my $start_time=time();
  my $mappingfile=$cwd."\/"."Modules"."\/"."Echinobase-Pmin_Map.txt";
  my $dirToScript=$cwd."\/"."Modules"."\/"."TPM_COUNT_Matrix_CSBB.pl";
 ...
 if($Species eq "echinobase-spur")
 {
  print "Read all parameters \.\. Starting execution\n";
  my $start_time=time();
  my $mappingfile=$cwd."\/"."Modules"."\/"."Echinobase-Spur_Map.txt";
  my $dirToScript=$cwd."\/"."Modules"."\/"."TPM_COUNT_Matrix_CSBB.pl";
...
sub ProcessChIPATACSingleEnd
{
 ...
 if($species eq "")
 {
  print "\nPlease provide the species \.\. Options : echinobase-pmin, echinobase-spur, human or mouse or xenopus-laevis and xenopus-trop\n";
  $species=<stdin>;chomp $species;
 }
 if($output_folder eq "")
 {
 ...
 if( $species eq "echinobase-pmin")
 {
  my $bowtie_index=$cwd."\/"."Modules"."\/"."Bowtie_indexes_Echinobase/Pmin";
  my $path_to_bamtobigwig=$cwd."\/"."Modules"."\/"."Bedgraph_Bigwig_MAC"."\/"."./bedGraphToBigWig";
  my $path_to_chromsize=$cwd."\/"."Modules"."\/"."Trop_chrom_sizes.genome";
  my $genomesize="6.08e8";
  my $start_time=time();
 ...
 if( $species eq "echinobase-spur")
 {
  my $bowtie_index=$cwd."\/"."Modules"."\/"."Bowtie_indexes_Echinobase/Spur";
  my $path_to_bamtobigwig=$cwd."\/"."Modules"."\/"."Bedgraph_Bigwig_MAC"."\/"."./bedGraphToBigWig";
  my $path_to_chromsize=$cwd."\/"."Modules"."\/"."Trop_chrom_sizes.genome";
  my $genomesize="9.22e8";
  my $start_time=time();
